...
/**
 * Represents aqd:LocalIncrementType
 */
@XmlAccessorType(XmlAccessType.NONE)
public class LocalIncrementType {
    ...
    public void populate(LocalincrementBean p) {
        ...
        natural.populate(p.getNaturallocalincrement(), "http://dd.eionet.europa.eu/vocabulary/uom/concentration/ug.m-3", p.getNaturallocalincrementcomment(), p.isNaturallocalincrement_nil(), p.getNaturallocalincrement_nilreason());
    ...
    public void setObject(LocalincrementBean p) {
        ...
        p.setNaturallocalincrement(natural.getValue());
        p.setNaturallocalincrementcomment(natural.getComment());
        p.setNaturallocalincrement_nil(natural.isNilReason());
        p.setNaturallocalincrement_nilreason(natural.getNilReason());
