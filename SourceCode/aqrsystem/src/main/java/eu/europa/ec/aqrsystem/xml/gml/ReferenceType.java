...
public class ReferenceType {
     ...
     */
    public ReferenceType setHref(String href, boolean nillable) {
        this.href = href;
        if (nillable) {
            this.nil = "false";
        }
     ...
     * Setter
     *
     * @param nilReason The value to be set
     * @return The object called
     */
    public ReferenceType setNilReason(String nilReason) {
