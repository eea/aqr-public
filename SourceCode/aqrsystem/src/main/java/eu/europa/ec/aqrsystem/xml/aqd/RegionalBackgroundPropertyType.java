...
/**
 * Represents aqd:RegionalBackgroundPropertyType
 */
@XmlAccessorType(XmlAccessType.NONE)
public class RegionalBackgroundPropertyType {

    @XmlElement(namespace = Namespaces.aqd)
    protected RegionalBackgroundType RegionalBackground = new RegionalBackgroundType();

    public void populate(RegionalbackgroundBean p) {
        RegionalBackground.populate(p);
    }

    public void setObject(RegionalbackgroundBean p) {
        RegionalBackground.setObject(p);
    }
}
