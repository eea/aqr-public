...
/**
 * Represents aqd:PublicationPropertyType
 */
@XmlAccessorType(XmlAccessType.NONE)
public class PublicationPropertyType {

    @XmlElement(namespace = Namespaces.aqd)
    protected PublicationType Publication = new PublicationType();

    public PublicationPropertyType populate(PublicationBean p) {
        Publication.populate(p);
        return this;
    }

    public void saveToPlan(String planId) throws Exception {
        Publication.saveToPlan(planId);
    }

    public void saveToScenario(String scenarioId) throws Exception {
        Publication.saveToScenario(scenarioId);
    }
}
