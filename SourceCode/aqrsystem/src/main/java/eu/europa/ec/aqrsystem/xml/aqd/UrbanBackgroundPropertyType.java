...
/**
 * Represents aqd:UrbanBackgroundPropertyType
 */
@XmlAccessorType(XmlAccessType.NONE)
public class UrbanBackgroundPropertyType {

    @XmlElement(namespace = Namespaces.aqd)
    protected UrbanBackgroundType UrbanBackground = new UrbanBackgroundType();

    public void populate(UrbanbackgroundBean p) {
        UrbanBackground.populate(p);
    }

    public void setObject(UrbanbackgroundBean p) {
        UrbanBackground.setObject(p);
    }
}
