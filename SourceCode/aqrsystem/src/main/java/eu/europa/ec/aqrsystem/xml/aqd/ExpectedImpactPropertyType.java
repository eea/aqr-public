...
/**
 * Represents aqd:ExpectedImpactPropertyType
 */
@XmlAccessorType(XmlAccessType.NONE)
public class ExpectedImpactPropertyType {

    @XmlElement(namespace = Namespaces.aqd)
    protected ExpectedImpactType ExpectedImpact = new ExpectedImpactType();

    public void populate(ExpectedimpactBean p) {
        ExpectedImpact.populate(p);
    }

    public void setObject(ExpectedimpactBean p, ActionBeanContext context) {
        ExpectedImpact.setObject(p, context);
    }
}
