...
/**
 * Represents aqd:PollutantPropertyType
 */
@XmlAccessorType(XmlAccessType.NONE)
public class PollutantPropertyType {

    @XmlElement(namespace = Namespaces.aqd)
    protected PollutantType Pollutant = new PollutantType();

    public PollutantPropertyType populate(PollutantBean pol, ProtectiontargetBean pt) {
        Pollutant.populate(pol, pt);
        return this;
    }

    public void save(String planId, ActionBeanContext context) throws Exception {
        Pollutant.save(planId, context);
    }
}
