...
/**
 * Represents aqd:AdjustmentMethodPropertyType
 */
@XmlAccessorType(XmlAccessType.NONE)
public class AdjustmentMethodPropertyType {

    @XmlElement(namespace = Namespaces.aqd)
    protected AdjustmentMethodType AdjustmentMethod = new AdjustmentMethodType();

    public void populate(DeductionassessmentmethodBean p, String namespace) {
        AdjustmentMethod.populate(p, namespace);
    }

    public void setObject(DeductionassessmentmethodBean p, String sourceId) throws Exception {
        AdjustmentMethod.setObject(p, sourceId);
    }
}
