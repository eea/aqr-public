...
/**
 * Represents aqd:ExceedanceDescriptionPropertyType
 */
@XmlAccessorType(XmlAccessType.NONE)
public class ExceedanceDescriptionPropertyType {

    @XmlElement(namespace = Namespaces.aqd)
    protected ExceedanceDescriptionType ExceedanceDescription = new ExceedanceDescriptionType();

    public void populate(ExceedancedescriptionBean p, String namespace) {
        ExceedanceDescription.populate(p, namespace);
    }
