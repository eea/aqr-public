...
<table id="publicationGUItable">
    ...
    <tbody>
        <c:forEach var="publication" items="${actionBean.publications}">
            <tr>
                <td>
                    <s:link beanclass="eu.europa.ec.aqrsystem.action.PublicationActionBean" event="form" class="edit-item">
                ...
                <td>
                    <s:link beanclass="eu.europa.ec.aqrsystem.action.PublicationActionBean" event="form" class="ftm edit edit-item" title="${res['common.edit']}">
                        <s:param name="planId" value="${actionBean.planId}"/>
                        <s:param name="publicationId" value="${publication.uuid}"/>
                        <div class="hidden"></div>
                    </s:link>
                    <security:allowed event="save">
                        <s:link beanclass="eu.europa.ec.aqrsystem.action.PublicationActionBean" event="delete" class="ftm delete confirm ajax-operation" title="${res['common.delete']}">
                            <s:param name="planId" value="${actionBean.planId}"/>
                            <s:param name="publicationId" value="${publication.uuid}"/>
                            <div class="hidden"></div>
                        </s:link>
