...
<s:layout-render name="/WEB-INF/jsp/common/layout.jsp">
    <s:layout-component name="content">
        ...
        <p>${res['loginpage.explanation.option7']} <a href="http://www.eionet.europa.eu/aqportal/plansandprogrammes" target="_blank">${res['loginpage.explanation.option7.helpdesk']}</a></p>
