...
public class UrbanbackgroundBean implements Serializable {
    ...
    public UrbanbackgroundBean() {
    }

    public UrbanbackgroundBean(String uuid) {
        this.uuid = uuid;
    }

    public UrbanbackgroundBean(String uuid, String total, String traffic, String heatandpowerproduction, String agriculture, String commercialandresidential, String shipping, String offroadmobilemachinery, String naturalurbanbackground, String transboundary) {
        this.uuid = uuid;
        this.total = total;
    ...
    public boolean isNaturalurbanbackground_nil() {
        return naturalurbanbackground_nil;
    }

    public void setNaturalurbanbackground_nil(boolean naturalurbanbackground_nil) {
        this.naturalurbanbackground_nil = naturalurbanbackground_nil;
    }

    public String getNaturalurbanbackground_nilreason() {
        return naturalurbanbackground_nilreason;
    }

    public void setNaturalurbanbackground_nilreason(String naturalurbanbackground_nilreason) {
        this.naturalurbanbackground_nilreason = naturalurbanbackground_nilreason;
    }
